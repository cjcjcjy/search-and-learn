...
class Config:
    ...
    model_path: str = "/data/disk2/jjxiao/Llama-3.2-1B-Instruct/"
    gpu_memory_utilization: float = (
        0.90  # vllm is allocated 0.5 of GPU memory, the PRM uses the rest
    )
    ...
    # dateset_file
    dataset_file: str = "gsm8k"
    # prm_file
    prm_file: str = "math-psa"
