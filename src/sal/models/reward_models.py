...
class RLHFFlow(PRM):
    def load_model_and_tokenizer(
        ...
        tokenizer = AutoTokenizer.from_pretrained(
            # "/data/disk2/jjxiao/RLHFlow/Llama3.1-8B-PRM-Deepseek-Data"
            "/data/disk2/jjxiao/RLHFlow/Llama3.1-8B-PRM-Mistral-Data"
        )
        model = AutoModelForCausalLM.from_pretrained(
            # "/data/disk2/jjxiao/RLHFlow/Llama3.1-8B-PRM-Deepseek-Data",
            "/data/disk2/jjxiao/RLHFlow/Llama3.1-8B-PRM-Mistral-Data",
...
class Math_psa(PRM):
    ...
    #     self, **model_kwargs
    # ) -> tuple[PreTrainedModel, PreTrainedTokenizer]:
    #     prm_model_path = "/data/disk2/jjxiao/Skywork/Skywork-o1-Open-PRM-Qwen-2.5-1.5B"
    #     tokenizer = AutoTokenizer.from_pretrained(
...
class llemma_7b_prm_prm800k(PRM):
    ...
    def load_model_and_tokenizer(
        ...
        # model_name = "/data/disk2/jjxiao/ScalableMath/llemma-7b-prm-prm800k-level-1to3-hf"
        model_name = "/data/disk2/jjxiao/ScalableMath/llemma-7b-prm-metamath-level-1to3-hf/"
        # model_name = "/data/disk2/jjxiao/ScalableMath/llemma-7b-oprm-prm800k-level-1to3-hf"
...
class Qwen(PRM):
    ...
    def load_model_and_tokenizer(
        ...
        tokenizer = AutoTokenizer.from_pretrained(
            # "/data/disk2/jjxiao/Qwen/Qwen2.5-Math-PRM-7B"
            "/data/disk2/jjxiao/Qwen/Qwen2.5-Math-7B-PRM800K"
        )
        model = AutoModelForCausalLM.from_pretrained(
            # "/data/disk2/jjxiao/Qwen/Qwen2.5-Math-PRM-7B",
            "/data/disk2/jjxiao/Qwen/Qwen2.5-Math-7B-PRM800K",
...
class Skywork_o1_Open_PRM(PRM):
    def load_model_and_tokenizer(
        ...
        # prm_model_path = "/data/disk2/jjxiao/Skywork/Skywork-o1-Open-PRM-Qwen-2.5-1.5B"
        prm_model_path = "/data/disk2/jjxiao/Skywork/Skywork-o1-Open-PRM-Qwen-2.5-7B/"
...
def load_prm(config: Config) -> PRM:
    ...
    if config.prm_path == "llemma_7b_prm_prm800k":
        return llemma_7b_prm_prm800k(config)
    
    if config.prm_path == "PURE_PRM_7B":
        return PURE_PRM_7B(config) 

    if config.prm_path == "qwen":
        return Qwen(config)

    if config.prm_path == "Skywork-o1-Open-PRM-Qwen-2.5":
